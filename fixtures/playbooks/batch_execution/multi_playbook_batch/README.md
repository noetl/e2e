...
tool:
  kind: playbook
  path: fixtures/playbooks/data_transfer/http_to_postgres_simple
  payload:
...
2. **Child Playbooks Registered**:
   ```bash
   noetl catalog register fixtures/playbooks/data_transfer/http_to_postgres_simple/http_to_postgres_simple.yaml
   noetl catalog register fixtures/playbooks/control_flow_workbook/control_flow_workbook.yaml
   noetl catalog register fixtures/playbooks/duckdb_gcs_workload_identity/workload_identity.yaml
   ```
...
noetl catalog register fixtures/playbooks/batch_execution/multi_playbook_batch/multi_playbook_batch.yaml
