...
def test_playbook_validation_tool_required():
    ...
    with pytest.raises(ValidationError) as exc_info:
        register_playbook("fixtures/playbooks/broken_playbooks/should_error_tool_is_required.yaml")
...
noetl catalog register fixtures/playbooks/broken_playbooks/should_error_tool_is_required.yaml
...
curl -X POST http://localhost:8082/api/catalog/register \
  ...
  -d '{
    "file_path": "fixtures/playbooks/broken_playbooks/should_error_tool_is_required.yaml"
  }'
