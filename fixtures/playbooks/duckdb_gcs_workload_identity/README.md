...
noetl playbook register fixtures/playbooks/duckdb_gcs_workload_identity/duckdb_gcs_workload_identity.yaml

# Execute playbook
noetl execution create fixtures/playbooks/duckdb_gcs_workload_identity/workload_identity --data '{}'
