...
### 1. Test Playbook
**File**: `fixtures/playbooks/data_transfer/http_iterator_save_postgres/http_iterator_save_postgres.yaml`
...
### 2. Documentation
**File**: `fixtures/playbooks/data_transfer/http_iterator_save_postgres/README.md`
...
noetl playbook register fixtures/playbooks/data_transfer/http_iterator_save_postgres

noetl execution create fixtures/playbooks/data_transfer/http_iterator_save_postgres
```
...
noetl execute playbook \
  fixtures/playbooks/data_transfer/http_iterator_save_postgres \
  --host localhost \
  --port 8083 \
...
### Test Files
1. **`fixtures/playbooks/data_transfer/http_iterator_save_postgres/http_iterator_save_postgres.yaml`**
...
2. **`fixtures/playbooks/data_transfer/http_iterator_save_postgres/HTTP_ITERATOR_SAVE_SUMMARY.md`** (this file)
   - Test documentation and bug analysis

3. **`fixtures/playbooks/data_transfer/http_iterator_save_postgres/README.md`**
