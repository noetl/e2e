...
### 1. Register Playbook
```bash
noetl playbook register fixtures/playbooks/data_transfer/http_to_postgres_direct
```

### 2. Execute Playbook
```bash
noetl execution create fixtures/playbooks/data_transfer/http_to_postgres_direct
```
...
```
fixtures/playbooks/data_transfer/http_to_postgres_direct/
...
- **Kind**: Playbook
- **Path**: fixtures/playbooks/data_transfer/http_to_postgres_direct
