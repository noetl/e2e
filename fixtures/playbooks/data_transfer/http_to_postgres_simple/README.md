...
noetl playbook register fixtures/playbooks/data_transfer/http_to_postgres_simple

# Execute the playbook
noetl execution create fixtures/playbooks/data_transfer/http_to_postgres_simple

# Or execute with local PostgreSQL credentials explicitly
noetl execute playbook \
  "fixtures/playbooks/data_transfer/http_to_postgres_simple" \
