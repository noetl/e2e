...
noetl playbook register fixtures/playbooks/data_transfer/snowflake_postgres

# Execute with default credentials
noetl execution create fixtures/playbooks/data_transfer/snowflake_postgres
```
...
noetl execute playbook \
  fixtures/playbooks/data_transfer/snowflake_postgres \
  --host localhost \
  --port 8083 \
...
**Credential Structure** (`fixtures/credentials/sf_test.json`):
```json
{
  "name": "sf_test",
  "type": "snowflake",
...
### Test Playbook
- **`fixtures/playbooks/data_transfer/snowflake_postgres/snowflake_postgres.yaml`**
...
### Documentation
- **`fixtures/playbooks/data_transfer/snowflake_postgres/README.md`**
  - Detailed usage guide
  - Configuration examples
  - Troubleshooting section

- **`fixtures/playbooks/data_transfer/snowflake_postgres/SUMMARY.md`** (this file)
...
- **`fixtures/credentials/sf_test.json`**
