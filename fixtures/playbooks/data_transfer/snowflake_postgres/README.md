...
**Location**: `fixtures/playbooks/data_transfer/snowflake_postgres/snowflake_postgres.yaml`

**Path**: `fixtures/playbooks/data_transfer/snowflake_postgres`
...
4. Snowflake credentials configured in `fixtures/credentials/sf_test.json`
...
**Check**:
1. Verify Snowflake credentials in `fixtures/credentials/sf_test.json`
