...
.venv/bin/noetl execute playbook \
  "fixtures/playbooks/data_transfer/http_to_postgres_transfer" \
...
curl -X POST http://localhost:8083/api/run/playbook \
  ...
  -d '{
    "path": "fixtures/playbooks/data_transfer/http_to_postgres_transfer",
...
noetl run fixtures/playbooks/data_transfer/http_to_postgres_transfer/http_to_postgres_transfer.yaml
...
# 3. Execute playbook
noetl run fixtures/playbooks/data_transfer/http_to_postgres_simple/http_to_postgres_simple.yaml
...
1. Create subfolder: `fixtures/playbooks/data_transfer/new_pattern/`
