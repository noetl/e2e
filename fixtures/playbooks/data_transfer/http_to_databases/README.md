...
```bash
noetl playbook register fixtures/playbooks/data_transfer/http_to_databases
```

### Execute the Playbook

```bash
noetl execution create fixtures/playbooks/data_transfer/http_to_databases
```
...
noetl execute playbook \
  fixtures/playbooks/data_transfer/http_to_databases \
