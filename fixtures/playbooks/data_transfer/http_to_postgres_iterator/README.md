...
```bash
noetl playbook register fixtures/playbooks/data_transfer/http_to_postgres_iterator
```

### Execute the Playbook

```bash
noetl execution create fixtures/playbooks/data_transfer/http_to_postgres_iterator
```
...
noetl execute playbook \
  "fixtures/playbooks/data_transfer/http_to_postgres_iterator" \
