...
1. Register credentials for Postgres, CUDA-Q, and HTTP collaborators as needed (see `fixtures/credentials/` for templates).
2. Register the playbook: `noetl register fixtures/playbooks/quantum_cudaq/quantum_cudaq.yaml --host localhost --port 8082`.
