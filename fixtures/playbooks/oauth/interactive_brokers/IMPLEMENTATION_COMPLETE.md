...
**Validation Script**: `fixtures/playbooks/oauth/interactive_brokers/validate_implementation.py`
...
.venv/bin/python fixtures/playbooks/oauth/interactive_brokers/validate_implementation.py
```
...
**Credentials Guide**: `fixtures/credentials/README.md`
...
**File**: `fixtures/credentials/ib_oauth.json`
...
**File**: `fixtures/playbooks/oauth/interactive_brokers/ib_oauth.yaml`
...
# Copy template
cp fixtures/credentials/ib_oauth.json.example \
   fixtures/credentials/ib_oauth.json
...
.venv/bin/noetl execute playbook \
  "fixtures/playbooks/oauth/interactive_brokers" \
...
**API Version**: 2.21.0
**Documentation**: `fixtures/playbooks/oauth/interactive_brokers/api-docs.json`
