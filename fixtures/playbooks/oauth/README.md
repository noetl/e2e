...
See `fixtures/credentials/README.md` for detailed setup instructions.

### 3. Run Tests

```bash
# Test Secret Manager
noetl run fixtures/playbooks/oauth/google_secret_manager/google_secret_manager.yaml

# Test GCS
noetl run fixtures/playbooks/oauth/google_gcs/google_gcs.yaml
```
