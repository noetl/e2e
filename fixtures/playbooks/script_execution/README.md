...
noetl playbook register fixtures/playbooks/script_execution/python_file_example.yaml
noetl execution create python_file_script_example --data '{}'

noetl playbook register fixtures/playbooks/script_execution/postgres_file_example.yaml
noetl execution create postgres_file_script_example --data '{}'

# HTTP source test (requires internet)
noetl playbook register fixtures/playbooks/script_execution/python_http_example.yaml
noetl execution create python_http_script_example --data '{}'

# Cloud source tests (requires credentials - see Prerequisites above)
noetl playbook register fixtures/playbooks/script_execution/python_gcs_example.yaml
noetl execution create python_gcs_script_example --data '{}'

noetl playbook register fixtures/playbooks/script_execution/postgres_s3_example.yaml
...
noetl playbook register fixtures/playbooks/script_execution/k8s_job_python_gcs.yaml
