...
noetl playbook register fixtures/playbooks/control_flow_workbook/control_flow_workbook.yaml

# Execute control flow workbook test
noetl execution create fixtures/playbooks/control_flow_workbook/control_flow_workbook --data '{}'
