...
noetl catalog register fixtures/playbooks/api_integration/amadeus_ai_api/amadeus_ai_api.yaml
...
File: `fixtures/playbooks/api_integration/amadeus_ai_api/router_example.graphql`
```
