...
```
fixtures/playbooks/api_integration/auth0/
...
```bash
# 1. Provision schema
noetl register-credential -f fixtures/credentials/pg_k8s.json
noetl register-playbook -f fixtures/playbooks/api_integration/auth0/provision_auth_schema.yaml
...
noetl register-credential -f fixtures/credentials/pg_auth_user.json

# 4. Register auth playbooks
noetl register-playbook -f fixtures/playbooks/api_integration/auth0/auth0_login.yaml
noetl register-playbook -f fixtures/playbooks/api_integration/auth0/auth0_validate_session.yaml
noetl register-playbook -f fixtures/playbooks/api_integration/auth0/check_playbook_access.yaml
```
