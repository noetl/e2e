...
noetl playbook register fixtures/playbooks/save_storage_test/save_all_storage_types.yaml
...
```bash
# Register the playbook
noetl playbook register fixtures/playbooks/save_storage_test/save_simple_test.yaml
...
```bash
# Register the playbook
noetl playbook register fixtures/playbooks/save_storage_test/save_edge_cases.yaml
...
```bash
noetl playbook register fixtures/playbooks/save_storage_test/create_tables.yaml
...
```bash
# From the project root
bash fixtures/playbooks/save_storage_test/validate_tests.sh
```
- The script will:
