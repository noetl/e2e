...
| `noetl run automation/playbooks/register.yaml --set path=fixtures/playbooks/container_postgres_init` | Register playbook |
| `noetl run fixtures/playbooks/container_postgres_init/container_postgres_init.yaml` | Execute playbook |
