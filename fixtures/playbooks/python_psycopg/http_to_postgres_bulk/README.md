...
.venv/bin/noetl execute playbook \
  "fixtures/playbooks/python_psycopg/http_to_postgres_bulk/http_to_postgres_bulk_python" \
...
```
fixtures/playbooks/python_psycopg/http_to_postgres_bulk/
...
- **Path**: fixtures/playbooks/python_psycopg/http_to_postgres_bulk_python
