...
noetl catalog playbooks register fixtures/playbooks/keychain/google_id_token/google_id_token_test.yaml

# Execute test
noetl catalog playbooks execute fixtures/playbooks/keychain/google_id_token
```
