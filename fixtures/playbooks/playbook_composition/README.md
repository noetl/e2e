...
noetl playbook register fixtures/playbooks/playbook_composition/playbook_composition.yaml

# Execute playbook composition test
noetl execution create fixtures/playbooks/playbook_composition/playbook_composition --data '{}'
