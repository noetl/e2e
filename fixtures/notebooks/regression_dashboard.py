...
# like `fixtures/playbooks/regression_test/master_regression_test.yaml`.
#
# Use it to:
...
# `fixtures/credentials/pg_local.json`. If not found, it falls back to
...
#%%
PLAYBOOK_PATH = 'fixtures/playbooks/regression_test/master_regression_test.yaml'
HOURS_BACK = 72
LIMIT = 200
