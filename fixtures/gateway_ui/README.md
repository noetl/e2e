...
The HTML/JS files are **completely separate** from the gateway - they're just a frontend that makes API calls.n fixtures/gateway_ui/login.html
...
2. **Start UI server**: `cd fixtures/gateway_ui && python3 -m http.server 8090`
