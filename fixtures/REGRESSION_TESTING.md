...
```bash
noetl run fixtures/playbooks/regression_test/register_credentials.yaml
```
...
noetl run fixtures/playbooks/hello_world/hello_world.yaml
```
...
### Configuration File: `fixtures/playbook_test_config.yaml`
...
playbooks:
  - name: hello_world
    path: fixtures/playbooks/hello_world/hello_world
    category: basic
    enabled: true
...
noetl run fixtures/playbooks/path/to/playbook.yaml
```
...
- `fixtures/playbook_test_config.yaml` - Test configuration
- `fixtures/expected_results/` - Expected result JSON files
- `fixtures/playbooks/regression_test/` - Regression test playbooks
